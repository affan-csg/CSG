...
export const faqs: Faq[] = [
  {
    audience: "clients",
    q: "Why do you charge 10% for direct hire when the industry charges 20-40%?",
    a: "We charge 10% of annual salary for direct hire. Standard US staffing fees run 20-40% of first-year salary, so on a $150,000 hire that's $30,000-$60,000 to a staffing firm versus our $15,000. Same vetting, same guarantee. On five hires a year, that's $75,000-$225,000 back in your budget.",
  },
  {
    audience: "clients",
    q: "What's the difference between a single specialist and a consulting pod?",
    a: "A specialist is one person placed into a seat you have already defined. A pod is a complete, purpose-built team delivered under one contract, one invoice, and one point of contact. We size every pod against four variables: experience, communication skills, technical skills, and cost. Geography is decided only after the first three are settled.",
  },
  {
    audience: "clients",
  ...
  },
  {
    ...
    a: "Yes. US works for the seat that owns model strategy and talks to your executives, on direct hire, contract, or contract-to-hire. LATAM is contract-only and has real depth in AI/ML right now, one of the highest-demand roles in the region. Pakistan is contract-only and strong for ML support engineering, data pipelines feeding models, and evaluation work.",
  },
  {
    audience: "clients",
  ...
  },
  {
    ...
    a: "We charge 10% of first-year salary, versus the 20-40% most staffing firms charge. AI/ML engineers typically start in the $134,000-$193,250 range in the US based on current market postings, so on a mid-range hire that's roughly $15,000-$19,000 to us instead of $30,000-$77,000 elsewhere.",
  },
  {
    audience: "clients",
  ...
  },
  {
    ...
    a: "10% of first-year salary, versus the 20-40% most staffing firms charge. Data engineers typically start in the $127,000-$180,750 range and data scientists in the $121,750-$182,500 range in the US market based on current postings, so the difference on a single hire typically runs into the tens of thousands.",
  },
  {
    audience: "clients",
  ...
  },
  {
    ...
    a: "10% of first-year salary, versus the industry-standard 20-40%. Software engineers typically start in the $109,250-$175,500 range in the US based on current market postings, so on a mid-range hire that's typically $11,000-$17,500 to us instead of $22,000-$70,000 elsewhere.",
  },
  {
    audience: "clients",
  ...
  },
  {
    ...
    a: "Based on current market postings, GRC specialists typically start in the $95,000-$145,000 range and security architects in the $130,000-$210,000 range in the US. On a direct hire, our fee is 10% of first-year salary rather than the 20-40% most staffing firms charge.",
  },
];
